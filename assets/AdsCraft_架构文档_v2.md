...
AIGC:
    ...
    PropagateID: 3476033405197864#1781764847030
    ReservedCode2: ""
---
...
| 层级 | 月价 | FB | TK | 交付物 |
|---|---|---|---|---|
| 免费层 | $0 | 通用方案+设置清单+诊断 | 拒审排查+诊断 | 诊断+最优解预览 |
...
### Step 7.7：TikTok全生命周期运营诊断
TikTok答题完成后追加账号阶段分支（新号/老号平平/老号掉量）；3套阶段诊断Prompt+综合建议模板；账号诊断与广告诊断合并输出；仅TikTok出现，FB不受影响
...
| 7.7 TikTok全生命周期诊断 | P1 | 差异化核心能力，覆盖起号到投流全阶段 |
| 8 Tab改造 | P1 | UI升级 |
| 9 诊断适配 | P1 | 差异化，含合规风险扫描 |
| 10 现有接口适配 | P1 | 兼容性 |
| 11 Cron刷新 | P2 | 可先手动 |
| 13 分析师智能进化架构 | P2 | 知识库+案例库+反馈闭环，提升诊断质量，非首期必须 |
| 14 智能体矩阵接入 | P2 | DeepSeek+pgvector，依赖Step 13，可后置 |
...
| DeepSeek API Key | **新增**，Step 13/14，platform.deepseek.com注册 |
| Supabase pgvector扩展 | **新增**，Step 13，`CREATE EXTENSION vector;` |
