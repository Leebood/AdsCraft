...
{
  "platform_detected": "facebook" 或 "tiktok" 或 "google" 或 "unknown"（根据截图判断的平台），
...
2. platform_detected 必须是 "facebook"、"tiktok"、"google" 或 "unknown" 之一；如果不是广告后台截图，请返回 "unknown"
3. 只提取截图中实际显示的数值
4. 如果找不到某个指标，返回 null`;
