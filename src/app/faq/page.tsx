...
export default function FAQPage() {
  ...
  const faqs = [
    ...
    },
    {
      qEn: 'Is it free?',
      qZh: '免费吗？',
      aEn: 'Basic analysis is free, no login required. For advanced features like history tracking and team collaboration, you can upgrade to a paid plan.',
      aZh: '基础分析免费，无需登录。对于高级功能如历史追踪和团队协作，您可以升级到付费计划。',
    },
    {
